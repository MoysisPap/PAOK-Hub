const Footer = () => {
  return (
    <footer className="bg-[#141a56] text-neutral-200 py-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top border */}
        <div className="w-full border-t-2 border-neutral-200 mb-4 mx-auto"></div>
        <div className="flex flex-col items-center space-y-4">
          <div className="flex flex-col sm:flex-row items-center justify-center text-lg text-center sm:text-left">
            <span>
              {/* Copyright notice with links */}© Copyright{' '}
              <a
                href="/"
              ...
              2024 | Powered by{' '}
              <a
                href="https://moysis-papadopoulos.netlify.app/"
                target="_blank"
